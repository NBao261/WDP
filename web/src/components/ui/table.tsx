...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn('bg-gray-50 text-gray-500 font-medium', className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'h-12 px-6 py-4 text-left align-middle font-medium text-gray-500 [&:has([role=checkbox])]:pr-0',
      className
    )}
    {...props}
  />
