    ...
    confirmState.type === 'lock'
      ...
      : confirmState.type === 'unlock'
        ...
        : confirmState.type === 'delete'
          ...
          : `Bạn có chắc chắn muốn đặt lại mật khẩu cho tài khoản "${confirmState.user?.name}"? Hệ thống sẽ tạo một mật khẩu mới ngẫu nhiên và gửi về email của người dùng. Người dùng cũng sẽ bị bắt buộc đổi mật khẩu ở lần đăng nhập tiếp theo.`;
